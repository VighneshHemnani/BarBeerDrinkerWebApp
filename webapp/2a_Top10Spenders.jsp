...
<html style = "font-family: sans-serif;">
	...
	<body style="background-color: #d5dee6;">
		<% try {
			...
			String str = "SELECT drinker, CEILING(SUM(total_price)) as 'totalspending' FROM BarBeerDrinkerProject.bills WHERE bar = \'"+entity+"\' GROUP BY drinker ORDER BY SUM(total_price) DESC LIMIT 10";
		...
		<tr>    
			...
			<%while (result.next()) 
				...
				<tr>    
					...
					<td><%= result.getString("totalspending") %></td>
				</tr>
