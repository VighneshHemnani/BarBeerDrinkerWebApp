...
<html style = "font-family: sans-serif;">
	...
	<body style="background-color: #d5dee6;">
		<% try {
			...
			String str = "SELECT t2.item as 'beer', CEILING(SUM(t2.quantity)) as 'totalsold' FROM BarBeerDrinkerProject.bills t1, BarBeerDrinkerProject.transactions t2 WHERE t1.bar = \'"+entity+"\' AND t2.bill_id = t1.bill_id AND t2.type = 'beer' GROUP BY beer ORDER BY totalsold DESC LIMIT 10";
